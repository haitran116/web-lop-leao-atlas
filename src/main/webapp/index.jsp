...
<body>
	...
	<div class="product-section mt-150 mb-150">
		<div class="container">
			<div class="lable-home">
				<p>SẢN PHẨM NỔI BẬT</p>
			</div>
			
			<div class="row">			
				<% int dem=0; for (Lopxe lo: db.Data_Lop_All()){ if(lo.getRate() > 4 && dem < 6){ %>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">		
							<a href="san-pham/<%=cn.url_san_pham(lo.getThuonghieu(), lo.getSize(), lo.getTensanpham()) %>"><img
								src="assets/img/products/anhlop/<%=lo.getNamefolder() %>/main.jpg" alt=""></a>
						</div>
						<h5>
							<%=cn.Rut_Gon_Ten_Lop(lo.getTensanpham()) %>
						</h5>
						<p class="product-price">
							<span> <%=lo.getThuonghieu() %>
							</span>
							<%=cn.chuan_hoa_gia(lo.getGiaban())+" VNĐ" %>
						</p>
						<div><a href="CookieCart?masp=<%=lo.getMasp() %>&num=1&jsp=index" class="cart-btn"><i
							class="fas fa-shopping-cart"></i> Thêm vào giỏ</a></div>
					</div>
				</div>
				<% 
				dem++;}
