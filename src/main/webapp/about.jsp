...
<head>
	...
	<meta name="description"
		content="Công ty Lốp LEAO - ATLAS Việt Nam | Lốp ô tô LEAO ATLAS Thailand nhập khẩu | Vỏ xe hơi LEAO ATLAS | Lốp ô tô LEAO ATLAS Thailand nhập khẩu | Vỏ xe hơi LEAO ATLAS | chuyên nhập khẩu và phân phối lốp ô tô made in ThaiLand">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>CÔNG TY LEAO - ATLAS VIỆT NAM</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Tại sao chọn <span class="orange-text">LEAO - ATLAS</span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										...
										<p>Hệ thống cửa hàng trải khắp cả nước.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Giá cả hợp lý</h3>
										<p>Giá thành tốt nhất tại Việt Nam.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										...
										<p>Với đội ngũ nhân viên có kinh nghiêm lâu năm về Lốp.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Kiểm hàng trước khi nhận</h3>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						<h3>NHÂN <span class="orange-text">VIÊN</span></h3>
						<p>ĐỘI NGŨ NHÂN VIÊN NHIỆT TÌNH, GIÀU KINH NGHIỆM</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-team-item">
						...
						<h4>Trần Thanh Tùng <span>NV Kinh doanh lốp</span> <span>0989131322</span></h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-team-item">
						<div class="team-bg team-bg-2"></div>
						<h4>Trần Thị Lan <span>NV phụ trách đại lý lốp xe du lịch</span> <span>0982909289</span></h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
					<div class="single-team-item">
						<div class="team-bg team-bg-3"></div>
						<h4>Trần Thị Liễu <span>NV Kinh doanh lốp</span> <span>0942999832</span></h4>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>A. Kim Long Hoàng <span>Khách mới</span></h3>
								<p class="testimonial-body">
									" Mình đi Captiva 2007, mới thay luôn 4 lốp đc hơn 2 tháng. Nói chung là rất ưng ý, giá cả phải chăng chỉ bằng 1/2 so với các hãng nổi tiếng, nhưng xe chạy rất êm, chịu tải tốt đó mình thường chở full tải. 5 sao cho Leao "
								</p>
								<div class="last-icon">
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>A. Hưng Nguyễn <span>Khách hàng lâu năm</span></h3>
								<p class="testimonial-body">
									" Mình đã và đang sử dụng dòng lốp 235/45r18 Atlas. Khách quan mà nói có thể gọi là rất ưng ý. Do bản thân đã đi lốp của mitchelin primecy 4 và Bireston t005. Lốp Atlas đi êm ái, giảm xóc, giảm ồn rất tốt. Hoa lốp đẹp, chi tiết lốp mịn màng, hoàn thiện tốt. Đi đường k bị ăn đá dăm, sỏi nhỏ. Mình rất hài lòng với số tiền bỏ ra hợp lý mà nhận đc sản phẩm rất ưng ý như này. Cảm ơn Leao - Atlas nhiều "
								</p>
								<div class="last-icon">
									<i class="fas fa-quote-right"></i>
								</div>
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>A. Nguyễn Bảo Long <span>Khách hàng lâu năm</span></h3>
								<p class="testimonial-body">
									" Lốp mềm các rãnh lốp rất đẹp,cách đóng gói lốp của nhà sản xuất cũng rất cẩn thận,sau khi sử dụng lốp rất yên tâm độ bám đường tốt mức độ ồn vừa phải,mình đã mua và sử dụng và có mua hộ nhiều xe khác,khách hàng rất hài lòng khi sử dụng so với các loại lốp đang thịnh hành thì thương hiệu lốp leao là sự lụa chọn sáng suốt,giá cả phải chăng độ bền tương đối ổn chắc chắn phải 10 vạn mới phải thay lốp "
								</p>
								<div class="last-icon">
									<i class="fas fa-quote-right"></i>
								</div>
