...
<body>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>Hỗ trợ 24/7</p>
						<h4 style="color: white;">Hotline: 0989131322 - Ms.Lan: 0982909289 - Ms.Liễu: 0942999832</h4>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						<h2>Anh/chị có câu hỏi gì hãy để lại thông tin cho bên em?</h2>
						<p>Mọi thắc mắc hay cần tư vấn bên em sẽ liên hệ lại ngay!</p>
					</div>

					<div class="contact-form">
						<form action="ghilienhe" method="POST" id="fruitkha-contact" onSubmit="tuvanngay()">
							<p>
								<input type="text" placeholder="Tên" name="name" id="name">
								<input type="text" placeholder="Email" name="email" id="email">
								<input type="tel" placeholder="Số điện thoại" name="phone" id="phone" pattern="[0-9]{10}" required>
							</p>

							<p><textarea name="message" id="message" cols="30" rows="10" placeholder="Nội dung"></textarea></p>
							<div><p><input type="submit" value="Tư vấn ngay"></p></div>
						</form>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<p>🏫CS1: Số 24, Khu Đấu Giá X3, P. Cự Khối, Long Biên, Hà Nôi.</p>
							<p>🏣CS2: Số 1 Trần Thủ Độ, Hoàng Liệt, Hoàng Mai Hà Nội.</p>
							<p>🏫CS3: Số 3, Đường 109A, khu DC Bắc Rạch Chiếc, P. Phước Long A, TP. Thủ Đức, Tp. HCM</p>
						</div>
						<div class="contact-form-box">
							<h4><i class="far fa-clock"></i> Giờ mở cửa</h4>
							<p>Thứ Hai - Thứ Bảy: 8h00 - 18h00</p>
						</div>
						<div class="contact-form-box">
							<h4><i class="fas fa-address-book"></i> Liên hệ</h4>
							<p>Điện thoại: 02422119115</p>
							<p>Hotline: 0989131322</p>
							<p>Email: alphayvietnam@gmail.com</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<p> <i class="fas fa-map-marker-alt"></i> Bản đồ cửa hàng</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="embed-responsive embed-responsive-21by9">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2634.4552363071853!2d105.84324380072935!3d20.965268854222398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ad74d1a3c819%3A0xfe92c89ab8aea643!2zTOG7kFAgw5QgVMOUIExFQU8sIEFUTEFTIFRIw4FJIExBTg!5e0!3m2!1svi!2s!4v1687402782006!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	</div>
